...
const OrderSummaryCard = () => {
  ...
  return (
    ...
    <p className="subtext">Showing <strong>{period}</strong> Order Summary</p>
    ...
    <div className="order-stats">
      ...
      <div className="progress-section">
        <div className="progress-label">
          ...
          <div className="bar">
            <div className="fill" style={{ width: `${getPercentage(data.takeAway)}%`, backgroundColor: COLORS.takeAway }} />
          </div>
        </div>
        <div className="progress-label">
          Served ({getPercentage(data.served)}%)
          <div className="bar">
            <div className="fill" style={{ width: `${getPercentage(data.served)}%`, backgroundColor: COLORS.served }} />
          </div>
        </div>
        <div className="progress-label">
          Dine In ({getPercentage(data.dineIn)}%)
          <div className="bar">
            <div className="fill" style={{ width: `${getPercentage(data.dineIn)}%`, backgroundColor: COLORS.dineIn }} />
          </div>
        </div>
      </div>
    </div>
